package org.olservice.config.securit;
...
public class TokenUtils {
    ...
    public static String generetToken (DTOLogin dtoUsuarioToken) {
        String jwtStr = Jwts.builder()
                .setSubject("TokemOlservice")
                .setHeaderParam("type", "jwt")
                .claim("nome", dtoUsuarioToken.getUsuario())
                .claim("senha",dtoUsuarioToken.getSenha())
                .signWith(
